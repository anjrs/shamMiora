...
CREATE TABLE article (
    ...
    auteur_id INT,                               -- référence à l'auteur
    date DATE NOT NULL,                          -- date de publication
    categorie_id INT,                            -- référence à la catégorie
    FOREIGN KEY (auteur_id) REFERENCES auteur(id),  -- clé étrangère vers auteur
    FOREIGN KEY (categorie_id) REFERENCES categorie(id) -- clé étrangère vers catégorie
);
